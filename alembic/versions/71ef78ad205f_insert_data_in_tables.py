...
def insert_data():
    cargo_table = table('cargo', column('id', sa.Integer), column('nome', sa.String),
                        column('cd_codigo', sa.String), column('salario', sa.Float))

    lider_table = table('lider', column('id', sa.Integer), column('nome', sa.String),
                        column('matricula', sa.String))

    status_colaborador_table = table('status_colaborador', column('id', sa.Integer),
                                     column('nome', sa.String),
                                     column('cd_status', sa.String))

    colaborador_table = table('colaborador', column('id', sa.Integer),
                              column('nome', sa.String), column('sobrenome', sa.String),
                              column('matricula',
                                     sa.String), column('senha', sa.String),
    ...
    op.bulk_insert(colaborador_table, [{
        ...
        'sobrenome': 'Pereira',
        'matricula': 'C001',
        'senha': get_password_hashed('123456'),
        'id_cargo': 1,
        'id_status': 1,
        'id_lider': 1
    }, {
        ...
        'sobrenome': 'Oliveira',
        'matricula': 'C002',
        'senha': get_password_hashed('654321'),
        'id_cargo': 2,
        'id_status': 1,
        'id_lider': 2
    }, {
        ...
        'sobrenome': 'Silva',
        'matricula': 'C003',
        'senha': get_password_hashed('abcdef'),
        'id_cargo': 3,
        'id_status': 2,
        'id_lider': 1
    }])
